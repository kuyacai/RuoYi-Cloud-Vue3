<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="一口价金额" prop="fixedPrice">
        <el-input
      ...
      <el-form-item label="限购数量" prop="userLimit">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['promotion:singleDiscountProduct:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['promotion:singleDiscountProduct:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['promotion:singleDiscountProduct:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['promotion:singleDiscountProduct:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="一口价金额" prop="fixedPrice">
          <el-input v-model="form.fixedPrice" placeholder="请输入一口价金额" />
        </el-form-item>
        <el-form-item label="立减金额" prop="deductionAmount">
        ...
        <el-form-item label="限购数量" prop="userLimit">
          <el-input v-model="form.userLimit" placeholder="请输入限购数量" />
        </el-form-item>
        <el-form-item label="添加时间" prop="addedTime">
          <el-date-picker clearable
...
<script>
import { listProduct, getProduct, delProduct, addProduct, updateProduct } from "@/api/promotion/singleDiscountProduct"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除单品直降活动商品编号为"' + ids + '"的数据项？').then(function() {
